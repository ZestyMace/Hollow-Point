...
internal sealed class HollowPointSprites : MonoBehaviour
{
    //Holds all the projectile sprites

    public static GameObject gunSpriteGO = null!;
    public static GameObject flashSpriteGO = null!;
    ...
    public void Start()
    {
        Log.Info("Intializing Weapon Sprites");
...
internal sealed class GunSpriteRenderer : MonoBehaviour
{
    public static SpriteRenderer gunRenderer = null!;
    public static Dictionary<string, Sprite> weaponSpriteDictionary = [];
    ...
    public static void SwapWeapon(string weaponName)
    {
        ...
        {
            Log.Error("No sprite with the name {0} was found", arg0: weaponName);
