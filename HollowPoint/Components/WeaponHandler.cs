...
//Weapon Swap
//===========================================================
public sealed class WeaponSwapAndStatHandler : MonoBehaviour
{
    public static WeaponSwapAndStatHandler instance { get; private set; } = null!;
    ...
    public void SwapWeapons()
    {
        ...
        if (instance.currentWeapon == WeaponType.Ranged)
        {
            ...
            Mirror.SetField(HeroController.instance, "attack_cooldown", 0.1f);
    ...
    private void ChangeWeaponSprite(WeaponType wt)
    {
        ...
        {
            Log.Error("Cannot find texture of the name {0}", arg0: spriteName);
    ...
    private void SwapBetweenNail()
    {
        ...
        Log.Debug("Changing weapons from {0} to {1}", prevWep, currentWeapon);
