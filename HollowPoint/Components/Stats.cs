...
{
    public static Stats instance { get; private set; } = null!;

    public static event Action<string> fireModeIcon = null!;
    ...
    public PlayerData pd_instance = null!;
    public HeroController hc_instance = null!;
    public AudioManager am_instance = null!;
    ...
    private bool Instance_OnEnableEnemyHook(GameObject enemy, bool isAlreadyDead)
    {
        ...
        {
            enemyList.Add(enemy);
            Log.Debug("adding {0} to the list", arg0: enemy.name);
        }
    ...
    public void CharmUpdate(PlayerData data, HeroController controller)
    {
        ...
        Log.Debug("currentFireCooldown {0}", current_fireRateCooldown);
    ...
    public void IncreaseAdrenalineChargeEnergy()
    {
        ...
        {
            Log.Debug("Increasing Charges Adrenaline Energy {0}", adrenalineEnergy);
    ...
    public void TakeAdrenalineEnergyDamage(int damageAmount)
    {
        ...
        Log.Debug("REMAINING energyRemaining {0}", energyRemaining);
        ...
        Log.Debug("REMAINING adrenalineCharges {0}", adrenalineCharges);
        Log.Debug("REMAINING adrenalineEnergy {0}", adrenalineEnergy);
