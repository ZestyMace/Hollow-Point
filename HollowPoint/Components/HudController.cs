...
internal sealed class HudController : MonoBehaviour
{
    /*
    ...
    */
    ...
    private GameObject directionalFireModeHudIcon = null!;
    private GameObject adrenalineHudIcon = null!;
    private GameObject canNailArtHudIcon = null!;
    private Dictionary<string, Sprite> hudSpriteDictionary = [];
    ...
    private void UpdateFireModeIcon(string firemode)
    {
        ...
        {
            Log.Error("Exception in UpdateFireModeIcon() Method: {0}", e);
        }
    ...
    private void UpdateAdrenalineIcon(string chargeLevel)
    {
        ...
        {
            Log.Error("Exception in UpdateAdrenalineIcon() Method: {0}", e);
        }
