...
internal sealed class AttackHandler : MonoBehaviour
{
    public static Rigidbody2D knight = null!;
    ...
    public IEnumerator SpreadShot()
    {
        ...
        for (int i = 0; i < pellets; i++)
        {
            ...
            hpbb.bulletOriginPosition = bullet.transform.position;
            hpbb.bulletSpeed = Stats.instance.current_bulletVelocity;
            hpbb.bulletDegreeDirection = pelletSpawnDegree + URandom.Range(-3f, 3f); ; //direction + UnityEngine.Random.Range(-20f, 20f);
            ...
            Destroy(bullet, Stats.instance.current_bulletLifetime + URandom.Range(-0.03f, 0.03f));
        }
        //HeatHandler.IncreaseHeat(Stats.instance.current_heatPerShot);
    ...
    public IEnumerator KnockbackRecoil(float recoilStrength, float applyForceFromDegree)
    {
        ...
        if (HeroController.instance.cState.facingRight)
        {
            ...
            Mirror.SetField(HeroController.instance, "recoilLarge", true);
