...
internal sealed class UIHandler : MonoBehaviour
{
    ...
    public Image heatbarImageEstimate = null!;
    public GameObject heatbar_go = null!;
    public GameObject heatbar_go_estimate = null!;
    public GameObject heatbar_go_border = null!;
    public GameObject energybar_go = null!;
    public GameObject energybar_go_border = null!;
    public void Start()
    {
...
public sealed class HP_DamageNumber : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        {
            Log.Error("EXCEPTION AT THE START: {0}", e);
        }
    }
    ...
    public IEnumerator DamageAnimation()
    {
        ...
        float xDeviation = URandom.Range(-0.5f, 0.5f);
        float acceleration = URandom.Range(0.15f, 0.25f);
        do
        {
    ...
    public IEnumerator DamageTextFadeOut()
    {
        ...
        {
            Color newColor = new(tm.color.r, tm.color.g, tm.color.b, Mathf.Lerp(alpha, 0, t));
            tm.color = newColor;
            yield return null;
        }
        Destroy(gameObject);
    ...
    public static void ShowDamageNumbers(string damage, HealthManager target, Color c)
    {
        ...
        {
            Log.Error("EXCEPTION AT THE DAMAGE INIT: {0}", e);
        }
    }
}
